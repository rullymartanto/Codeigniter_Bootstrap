  ...
  <div class="container">
	<div class="well">
		...
		<?php echo form_open_multipart('app_admin_photo/simpan','class="form-horizontal"'); ?>
    ...
    <tbody>
	<?php
		foreach($data_content->result_array() as $dp)
		{
	?>
      <tr>
        <td><input type="checkbox" name="item[]" id="item[]" value="<?=$id_album?>" /></td>
		<td><?php echo $dp['nama_album']; ?></td>
		<td ><?php echo $dp['foto_besar']; ?></td>
		<td>
	         <div class="btn-group">
			          <a class="btn small-box" href="<?php echo base_url(); ?>app_admin_photo/edit/<?php echo $dp['id_album']; ?>"><i class="icon-ok-circle"></i> Detail</a>
